...
class LoginController extends Controller
{
    ...
    public function activationCode($token)
    {
        ...
        if(!$user)
        {
            return redirect()->route('login')->with('danger', 'This user token doesn\'t  match any user.');
        }
    ...
    /**
     * Vérifier si l'utilisateur a deja activé son compte ou pas avant d'être authentifier**/
    ...
    public function activationAccontLink($token)
    {
        $user = User::where('activation_token', $token)->first();
